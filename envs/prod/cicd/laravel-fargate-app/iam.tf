      ...
      "Statement" : [
        {
          ...
          "Resource" : "arn:aws:s3:::k-taiga-tfstate /${local.system_name}/${local.env_name}/cicd/app_${local.service_name}_*.tfstate"
        },
      ]
  })
}

# ecsのtask操作のためのAWS公式のPolicy
